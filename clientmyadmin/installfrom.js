...
import { parseGithubURL } from './shared/itty-github-parser.js'

// const canImportJson = await import('data:application/json;,1', { with: { type: 'json' }})
//   .then(_ => true, _ => false)

// console.log('canImportJson', canImportJson)

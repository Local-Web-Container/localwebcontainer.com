...
var init_FileSystemHandle = __esm({
  "node_modules/native-file-system-adapter/src/FileSystemHandle.js"() {
    kAdapter = /* @__PURE__ */ Symbol("adapter");
...
var init_FileSystemFileHandle = __esm({
  "node_modules/native-file-system-adapter/src/FileSystemFileHandle.js"() {
    ...
    kAdapter2 = /* @__PURE__ */ Symbol("adapter");
...
var init_FileSystemDirectoryHandle = __esm({
  "node_modules/native-file-system-adapter/src/FileSystemDirectoryHandle.js"() {
    init_FileSystemHandle();
    kAdapter3 = /* @__PURE__ */ Symbol("adapter");
    FileSystemDirectoryHandle = class _FileSystemDirectoryHandle extends FileSystemHandle_default {
...
var p;
var kv = (method, ...args) => (p ??= new Promise((rs) => {
...
init_util();
var { GONE: GONE2, MISMATCH: MISMATCH2, SYNTAX: SYNTAX2, DISALLOWED: DISALLOWED3 } = errors;
  ...
  if (url.href.startsWith(origin)) {
    if (root?.type === "cors") {
      if (url.href.startsWith(root.url) && request.destination === "document") {
        url.href = url.href.replace(root.url, origin);
    ...
    if (root) {
      ...
      try {
        ...
        const file404 = await fs_default.open(root, "404.html").catch(() => null);
        if (file404?.kind === "file") {
          const file = await file404.getFile();
    ...
    if (pathname.startsWith(base)) {
      const url2 = new URL(pathname, base);
      return fetch2(`${base}/${pathname}`);
    }
